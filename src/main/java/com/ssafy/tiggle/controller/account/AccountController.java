package com.ssafy.tiggle.controller.account;

import com.ssafy.tiggle.dto.account.request.OneWonVerificationRequest;
import com.ssafy.tiggle.dto.account.request.OneWonVerificationValidateRequest;
import com.ssafy.tiggle.dto.account.request.PrimaryAccountRequest;
...
public class AccountController {
    ...
    public ResponseEntity<OneWonVerificationResponse> sendOneWonVerification(
            @Valid @RequestBody OneWonVerificationRequest request) {
    ...
    public ResponseEntity<OneWonVerificationValidateResponse> validateOneWonAuth(
            @Valid @RequestBody OneWonVerificationValidateRequest request) {
    ...
    public ResponseEntity<ApiResponse<AccountHolderInfoDto>> getAccountHolder(
            @NotNull @RequestParam String accountNo) {
